...
export default function LangModal({ open, onClose, language, count, films }: LangModalProps) {
  useEffect(() => {
    if (!open) return;
      ...
      {open && (
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
          ...
          <motion.div
            ...
            className="relative w-full max-w-md max-h-[80vh] flex flex-col bg-[#1a1a1a] border border-white/10 rounded-2xl overflow-hidden shadow-2xl"
